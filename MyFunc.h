...
//長さを計る関数
float Length(Vec2 pos1, Vec2 pos2);
float Length(Vec3 pos1, Vec3 pos2);
...
Vec3 Add(const Vec3& vector1, const Vec3& vector2);
Vec3 Subtract(const Vec3& vector1, const Vec3& vector2);
Vec3 Multiply(const Vec3& vector1, const Vec3& vector2);
Vec3 Multiply(const Vec3& vector1, float k);
...
void VecScreenPrintf(int posX, int posY, Vec2 vector,const char* string = 0);
void VecScreenPrintf(int posX, int posY, Vec3 vector,const char* string = 0);
